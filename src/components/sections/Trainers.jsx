      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-[10px] uppercase tracking-[0.4em] font-black text-brand-red">WORLD CLASS COACHES</span>
          </div>
          ...
          {trainers.map((trainer, i) => (
            ...
            >
              ...
              <div className="flex gap-4 opacity-40 group-hover:opacity-100 transition-opacity">
                ...
                <Twitter size={16} className="cursor-pointer hover:text-brand-red transition-colors" />
